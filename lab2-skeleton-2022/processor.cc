...
Processor::Processor(ELFFile &program, bool pipelining, bool debugMode)
  : bus{ program.createMemories() },
    ...
    pipeline{ pipelining, debugMode, PC, instructionMemory, decoder,
        regfile, PcMux_, BranchFlag_, isDelaySLot, controlSignal, dataMemory }
    
{
  ...
  PcMux_.setSelector(PipelineProperties::EPcSelect::PC_Start);
  PcMux_.setInput(PipelineProperties::EPcSelect::PC_Start, PC);
}
